...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.dictionariesValue.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.dictionaries-values.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('diccionario') ? 'is-invalid' : '' }}" name="diccionario_id" id="diccionario_id" required>
                    @foreach($diccionarios as $id => $entry)
                        <option value="{{ $id }}" {{ old('diccionario_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('texto_inicial') ? 'is-invalid' : '' }}" type="text" name="texto_inicial" id="texto_inicial" value="{{ old('texto_inicial', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('text_final') ? 'is-invalid' : '' }}" type="text" name="text_final" id="text_final" value="{{ old('text_final', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('valor_inicial') ? 'is-invalid' : '' }}" type="number" name="valor_inicial" id="valor_inicial" value="{{ old('valor_inicial', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('valor_final') ? 'is-invalid' : '' }}" type="number" name="valor_final" id="valor_final" value="{{ old('valor_final', '') }}" step="1">
